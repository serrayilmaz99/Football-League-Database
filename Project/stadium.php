...
<body>
  <section id="title">
        ...
        <div class="col-lg-4 buttons">
          <br><br><br><br>
            <form method="POST" >
              ...
              <input type="text" class="form-control" id="capacity" name="capacity" placeholder="Capacity" required><br>
              <input type="text" class="form-control" id="width" name="width" placeholder="Width" required><br>
              <input type="text" class="form-control" id="length" name="length" placeholder="Length" required><br>
            ...
            <div class="col-lg-3">
              ...
              <form method="POST">
                ...
                <input type="text" class="form-control" id="capacity" name="capacity" placeholder="Capacity" ><br>
                <input type="text" class="form-control" id="width" name="width" placeholder="Width" ><br>
                <input type="text" class="form-control" id="length" name="length" placeholder="Length" ><br>
    ...
    $sql_statement = "INSERT INTO `stadium` (stadiumID, teamID, city, capacity, width,length)
     									VALUES ($stadiumID, $teamID, '$city', $capacity,$width,$length)";
    ...
    // database insert SQL code
    $sql_statement = "DELETE FROM `stadium`
    ...
    // insert in database
    ...
    else if (isset($_POST['update'])){ // (stadiumID, teamID, city, capacity, width,length)
          if( ! (  (isset($_POST['stadiumID'])) && (strlen($_POST['stadiumID']) != 0)) || ! (  (isset($_POST['teamID'])) && (strlen($_POST['teamID']) != 0))  ){
            ?>
            <body style="background-color:#f2f4f7;">
              <br>
            <?php echo 'Stadium ID and Team ID must be specified to update';
          }
          else{
            $teamID = $_POST['teamID'];
            $stadiumID = $_POST['stadiumID'];
            $number_of_fields_filled = 0;
            $fields = array("stadiumID", "teamID", "city", "capacity", "width", "length");
            ...
            if($number_of_fields_filled == 0)
            {
              ...
              <?php echo "To be updated value must be filled for at least 1 field";
                ...
                // WHERE teamID = 1;
              $sql_statement = "UPDATE `stadium` SET ";
              ...
              foreach($fields as $field){
                if( isset($_POST[$field]) && strlen($_POST[$field]) !=0 )
                {
                  ...
                  if($number_of_commas > 0){
                    ...
                    $sql_statement .= " WHERE teamID = $teamID AND stadiumID = $stadiumID";
                  }
                }
              }
              if($db->query($sql_statement) == TRUE){
        ...
        //  if none are filled then show error message (stadiumID, teamID, city, capacity, width,length)
        $fields = array("stadiumID","teamID","city","capacity", "width", "length");
        $number_of_fields_filled = 0;
        ...
        $sql_statement = "SELECT * FROM `stadium` WHERE ";
        foreach ($fields as $field){
          if (isset($_POST[$field]) && strlen($_POST[$field]) != 0  ){
