...
<body>
  <section id="title">
        ...
        <div class="col-lg-4 buttons">
          <br><br><br><br>
            <form method="POST" >
              ...
              <button class="btn btn-outline-secondary btn-md " name="delete">Insert</button>
            </form>
            </div>
            <div class="col-lg-3">
    ...
    $sql_statement = "INSERT INTO `coach` (teamID, coachID, name, surname, nationality)
     									VALUES ($teamID, $coachID, '$name', '$surname', '$nationality')";
