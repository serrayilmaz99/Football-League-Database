...
<body>
  <section id="title">
          ...
          <br><br><br><br>
            ...
            <div class="col-lg-3">
              ...
              <form method="POST">
                ...
                <input type="text" class="form-control" id="rank" name="rank" placeholder="Rank" ><br>
                <input type="text" class="form-control" id="point" name="point" placeholder="Point" ><br>
                <input type="text" class="form-control" id="lose" name="lose" placeholder="Lose" ><br>
                <input type="text" class="form-control" id="won" name="won" placeholder="Won" ><br>
    ...
    $sql_statement = "INSERT INTO `standing` (teamID, rank, point, lose, won)
     									VALUES ($teamID, $rank, $point, $lose, $won)";
    ...
    // database insert SQL code
    $sql_statement = "DELETE FROM `standing`
                      WHERE teamID = $teamID";
    ...
    // insert in database
      ...
      if( ! (  (isset($_POST['teamID'])) && (strlen($_POST['teamID']) != 0))  ){
        ?>
        <body style="background-color:#f2f4f7;">
          <br>
        <?php echo 'Team ID must be specified to update'; //teamID, rank, point, lose, won)
      }
      else{
        $teamID = $_POST['teamID'];
        $number_of_fields_filled = 0;
        $fields = array("teamID","rank","point","lose","won");
        ...
        if($number_of_fields_filled == 0)
        {
          ...
          <?php echo "To be updated value must be filled for at least 1 field";
            ...
            // WHERE teamID = 1;
          $sql_statement = "UPDATE `standing` SET ";
          ...
          foreach($fields as $field){
            if( isset($_POST[$field]) && strlen($_POST[$field]) !=0 )
            {
              ...
              if($number_of_commas > 0){
                ...
                $sql_statement .= " WHERE teamID = $teamID";
              }
            }
          }
          if($db->query($sql_statement) == TRUE){
        ...
        //  if none are filled then show error message  (teamID, rank, point, lose, won)
        $fields = array("teamID","rank","point","lose", "won");
        $number_of_fields_filled = 0;
        ...
        $sql_statement = "SELECT * FROM `standing` WHERE ";
        foreach ($fields as $field){
          if (isset($_POST[$field]) && strlen($_POST[$field]) != 0  ){
